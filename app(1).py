...
st.title("Multidimensional Poverty Status Prediction App")

st.write("Fill in individual and household characteristics to predict poverty status.")
...
with st.form("prediction_form"):
    ...
    submitted = st.form_submit_button("Predict MPI Status")
...
if submitted:
    ...
    poverty_status = (y_pred > 0.5).astype(int)[0][0]

    st.write("Raw Prediction:", float(y_pred[0][0]))
    st.success("Household is POOR" if poverty_status == 1 else "Household is NOT POOR")
